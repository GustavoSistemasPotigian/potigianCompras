...
public class ConsultaArticulos extends javax.swing.JFrame {
    ...
    void CargarTablaPlanes(String valor){
       ...
       ///ingresamos la consulta
        sSQL="select pa.idPLan_Descuento as IdPlan,pr.razon_social as Proveedor, pa.idarticulo as IdArticulo, a.descripcion as Descripcion \n" +
              ...
              "inner join proveedor pr on pr.idProveedor= a.proveedor_idproveedor"+
